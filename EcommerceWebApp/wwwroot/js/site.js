...
document.addEventListener('click', function (event) {
    ...
    if (clickedElement.matches('.categories-dropdown a')) {
        ...
        // Navigate to the corresponding view based on the category
        navigateToCategoryView(category);
    }
});
...
function navigateToCategoryView(category) {
    switch (category) {
        case 'vehicles':
            window.location.href = '/Home/Vehicles'; // Replace with the actual URL
            break;
        case 'clothes':
            window.location.href = '/Home/Clothes'; // Replace with the actual URL
            break;
        case 'household-appliances':
            window.location.href = '/Home/Electronics'; // Replace with the actual URL
            break;
        default:
